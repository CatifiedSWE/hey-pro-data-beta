                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <LocationAutocomplete
                                ...
                                type="country"
                                className="h-12 rounded-2xl border border-input bg-background text-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 px-4"
                            />
                        </div>
